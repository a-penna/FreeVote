...
<a class="navbar-brand" href="<%=response.encodeURL(request.getContextPath() + "/admin/interfacciaAdmin.jsp")%>">
	<img src="/FreeVote/imgs/logoFreevote3.png" width="50" height="50"  alt="Logo FreeVote Admin"> 
</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a class="nav-link" href="<%=response.encodeURL(request.getContextPath() + "/home.jsp")%>"><span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
